<?php
    include_once 'backend/kSeriesHandle.php';
?>
    ...
    <div class="product-card-container">
            <div class="card">
                <div class="productBackground">
                    ...
                    <?php 
                        echo '<img src="image/kSeries/'.$colour_list[0]["image_path"].'" alt="" class="product show" color="'.$colour_list[0]["colour"].'">';
                        for($i = 1; $i < $result_size; $i++){
                            echo '<img src="image/kSeries/'.$colour_list[$i]["image_path"].'" alt="" class="product" color="'.$colour_list[$i]["colour"].'">';
                        }
                    ?>
                ...
                <div class="product-info">
                    ...
                    <div class="size-container">
                        <form action="kSeriesDetail.php" class="sizes">
